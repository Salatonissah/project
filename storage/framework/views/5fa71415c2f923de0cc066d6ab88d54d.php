    ...
    <section class="about-section">
        <div class="container">
            <div class="row align-items-center">
                    ...
                    <div id="aboutCarousel" class="carousel slide about-carousel" data-bs-ride="carousel" data-bs-interval="3500">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="<?php echo e(asset('assets/images/kca-library.png')); ?>" class="d-block w-100" alt="KCA Library">
                            </div>
                            <div class="carousel-item">
                                <img src="<?php echo e(asset('assets/images/library.jpg')); ?>" class="d-block w-100" alt="Library">
                            </div>
                        </div>
                ...
                <!-- Text Content -->
                <div class="col-lg-7">
                    <span class="about-title">ABOUT BOOKSHOP</span>
...
</html><?php /**PATH C:\xampp\htdocs\bookshop-app\resources\views\about.blade.php ENDPATH**/ ?>