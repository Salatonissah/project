        ...
        <div class="container">
            <div class="row">
                ...
                <div class="container mt-3 d-flex justify-content-end">
                    <a href="<?php echo e(url('/cart')); ?>" class="position-relative" style="text-decoration:none;">
                        <img src="<?php echo e(asset('assets/images/online-shopping.png')); ?>" alt="Cart" style="width:40px; height:40px;">
                ...
                <div class="col-lg-3 mb-4 mb-lg-0">
                    <div class="list-group" id="resource-tabs" role="tablist">
                        ...
                        <a class="list-group-item list-group-item-action py-4 mb-3" style="background:#8d99ae; border-radius:12px; font-size:1.2rem; color:#fff;" id="tab-food" data-bs-toggle="list" href="#food" role="tab">
                            <span class="me-3"><img src="<?php echo e(asset('assets/images/skill.png')); ?>" alt="Food & Life" style="width:48px;"></span>
                            Critical Thinking
                        </a>
                        <a class="list-group-item list-group-item-action py-4 mb-3" style="background:#8d99ae; border-radius:12px; font-size:1.2rem; color:#fff;" id="tab-cars" data-bs-toggle="list" href="#cars" role="tab">
                            <span class="me-3"><img src="<?php echo e(asset('assets/images/book.png')); ?>" alt="Cars" style="width:48px;"></span>
                            Novels
                        </a>
                        <a class="list-group-item list-group-item-action py-4 mb-3" style="background:#8d99ae; border-radius:12px; font-size:1.2rem; color:#fff;" id="tab-critical" data-bs-toggle="list" href="#critical" role="tab">
                            <span class="me-3"><img src="<?php echo e(asset('assets/images/skill.png')); ?>" alt="Critical Thinking" style="width:48px;"></span>
                            Critical Thinking
                        </a>
                    </div>
                </div>
                                                ...
                                                <div class="d-flex justify-content-end align-items-end flex-grow-1" style="position:absolute; bottom:1.5rem; right:1.5rem;">
                                                    <button
                                                        ...
                                                        onclick="addToCart({
                                                            ...
                                                            title: 'Learn to Code',
                                                            price: 'Ksh600',
                                                            image: '<?php echo e(asset('assets/images/code1.jfif')); ?>'
                                                        })"
                                                        type="button"
                                                    >Add</button>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-end align-items-end flex-grow-1" style="position:absolute; bottom:1.5rem; right:1.5rem;">
                                                    <button
                                                        ...
                                                        onclick="addToCart({
                                                            ...
                                                            title: 'Simply Coding',
                                                            price: 'Ksh750',
                                                            image: '<?php echo e(asset('assets/images/code2.jpg')); ?>'
                                                        })"
                                                        type="button"
                                                    >Add</button>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-end align-items-end flex-grow-1" style="position:absolute; bottom:1.5rem; right:1.5rem;">
                                                    <button
                                                        ...
                                                        onclick="addToCart({
                                                            ...
                                                            price: 'Ksh900',
                                                            image: '<?php echo e(asset('assets/images/code3.jpg')); ?>'
                                                        })"
                                                        type="button"
                                                    >Add</button>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-end align-items-end flex-grow-1" style="position:absolute; bottom:1.5rem; right:1.5rem;">
                                                    <button
                                                        ...
                                                        onclick="addToCart({
                                                            ...
                                                            price: 'Ksh200',
                                                            image: '<?php echo e(asset('assets/images/exam1.jpg')); ?>'
                                                        })"
                                                        type="button"
                                                    >Add</button>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-end align-items-end flex-grow-1" style="position:absolute; bottom:1.5rem; right:1.5rem;">
                                                    <button
                                                        ...
                                                        onclick="addToCart({
                                                            ...
                                                            price: 'Ksh750',
                                                            image: '<?php echo e(asset('assets/images/lib.jpg')); ?>'
                                                        })"
                                                        type="button"
                                                    >Add</button>
                                                </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-12">
                                    <div class="card mb-4" style="border-radius:16px;">
                                        <div class="row g-0">
                                            <div class="col-md-6">
                                                <img src="<?php echo e(asset('assets/images/featured-04.jpg')); ?>" class="img-fluid rounded-start" alt="Critical Thinking">
                                            </div>
                                                ...
                                                <div class="d-flex justify-content-end align-items-end flex-grow-1">
                                                    <button
                                                        ...
                                                        onclick="addToCart({
                                                            ...
                                                            price: 'Ksh550',
                                                            image: '<?php echo e(asset('assets/images/featured-04.jpg')); ?>'
                                                        })"
                                                        type="button"
                                                    >Add</button>
                                                </div>
