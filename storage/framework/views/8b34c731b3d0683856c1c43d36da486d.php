                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="reportsDropdown">
                            <li><a class="dropdown-item" onclick="showDashboard()">Daily</a></li>
                            <li><a class="dropdown-item" onclick="showDashboard()">Weekly</a></li>
                        </ul>
                    </li>
                    <!-- Accounts -->
                    <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="dashboard-card">
                                <div class="dashboard-section-title">Latest Hits</div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3">
                    <div class="dashboard-card text-center">
                        <img src="<?php echo e(asset('assets/images/profile.png')); ?>" class="profile-img" alt="Profile Image">
                        <form>
...
</html><?php /**PATH C:\xampp\htdocs\bookshop-app\resources\views\admin-panel.blade.php ENDPATH**/ ?>