                    ...
                    <div class="card-body">
                        <form id="paymentForm">
                            ...
                            <div id="cardFields">
                                ...
                                <div class="mb-3">
                                    <img src="<?php echo e(asset('assets/images/cards/visa.png')); ?>" alt="Visa" style="height:32px; width:auto; margin-right:8px;">
                                    <img src="<?php echo e(asset('assets/images/cards/mastercard.png')); ?>" alt="Mastercard" style="height:32px; width:auto; margin-right:8px;">
                                    <img src="<?php echo e(asset('assets/images/cards/amex.png')); ?>" alt="Amex" style="height:32px; width:auto; margin-right:8px;">
                                    <img src="<?php echo e(asset('assets/images/cards/discover.png')); ?>" alt="Discover" style="height:32px; width:auto; margin-right:8px;">
                                    <img src="<?php echo e(asset('assets/images/cards/maestro.png')); ?>" alt="Maestro" style="height:32px; width:auto; margin-right:8px;">
                                </div>
                                <div class="row mb-4">
                                    <div class="col">
                                        ...
                                        <select class="form-select" required>
                                            ...
                                            <?php for($m=1;$m<=12;$m++): ?>
                                                <option><?php echo e(sprintf('%02d', $m)); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                    </div>
                                    <div class="col">
...
</html><?php /**PATH C:\xampp\htdocs\bookshop-app\resources\views/pay.blade.php ENDPATH**/ ?>